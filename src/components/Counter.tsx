...
import { Clock, ThumbsUp, Gift } from "lucide-react";

const stats = [
  { icon: Clock, value: 24, suffix: "h", label: "Reaktionszeit", static: false },
  { icon: ThumbsUp, value: 100, suffix: "%", label: "Weiterempfehlung", static: false },
  { icon: Gift, value: 0, suffix: "", label: "Erstgespräch", staticText: "Kostenlos", static: true },
];
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-r from-primary to-primary-dark py-12 sm:py-16">
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-3 gap-6 md:gap-12 justify-items-center">
